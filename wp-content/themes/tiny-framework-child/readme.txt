...
Theme URI: http://mtomas.com/522/tiny-framework-child-themes
...
WordPress.org - free, but very limited support forum, that deals only with the issues of existing theme code:
	...
	http://wordpress.org/support/theme/tiny-framework
...
- Custom Headers for posts and pages (including random header rotator) and 3 footer widgets, integrated Social Menu for your networking links in the footer
...
- Icon webfont support - using FontAwesome icon webfont
...
Please see readme.txt of parent theme Tiny Framework or visit: http://mtomas.com/389/tiny-forge-framework-child-themes-comprehensive-guide


Tips and Tricks for child theme
===============================

In order to see search icon in the top menu, you have to select that menu as Primary Menu:

	Go to Admin Panel Menu > Appearance > Menus and check Primary Menu check box at the bottom right).

Ideas for header image: http://nicolasgallagher.com/flexible-css-cover-images/

For more information please see: http://mtomas.com/389/tiny-forge-framework-child-themes-comprehensive-guide
